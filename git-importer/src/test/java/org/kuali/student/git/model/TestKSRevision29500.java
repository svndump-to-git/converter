...
public class TestKSRevision29500 {
	...
	public void testRevision29500 () throws IOException {
		...
		GitImporterMain.main(new String [] {"src/test/resources/ks-r29500.dump.bz2", gitRepository.getAbsolutePath(), "target/ks-r29500-ks-veto.log", "target/ks-r29500-ks-copyFrom-skipped.log", "target/ks-r29500-blob.log", "0", "https://svn.kuali.org/repos/student", "uuid", "host:kuali.org"});
