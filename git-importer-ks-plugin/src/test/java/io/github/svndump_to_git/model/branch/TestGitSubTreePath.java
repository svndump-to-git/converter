 ...
 * the License.
 */
package io.github.svndump_to_git.model.branch;

import org.junit.Assert;
import org.junit.Ignore;
import org.junit.Test;
import io.github.svndump_to_git.branch.model.BranchData;
import io.github.svndump_to_git.model.AbstractKualiStudentBranchDetectorTest;
...
public class TestGitSubTreePath extends AbstractKualiStudentBranchDetectorTest {
	...
	public void testCreateSubTreeBlobPath() throws VetoBranchException {
		...
		String directoryPath = "poc/brms/brms-ri/branches/brms-ri-dev/inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/runtime/ast";
		
		String copyFromDirectoryPath = "poc/brms/brms-ri/branches/brms-ri-dev/inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/ast";

		String copyFromBlobPath = "inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/ast/BinaryTree.java";
		
		
		/*
		 * We want to end up with a path rooted in the path specified by the directoryPath (path from the svn dump)
		 * 
		 * poc/brms/brms-ri/branches/brms-ri-dev/inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/runtime/ast/BinaryTree.java
		 * 
		 */
		...
		Assert.assertEquals("poc/brms/brms-ri/branches/brms-ri-dev/inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/runtime/ast/BinaryTree.java", alteredBlobPath);
	...
	public void testKsRevision100() throws VetoBranchException {
		...
		String path = "poc/brms/brms-ri/branches/brms-ri-dev/inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/runtime/ast";
		
		String brachSubPath = "inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/runtime/ast";
		
		String copyFromPath = "poc/brms/brms-ri/branches/brms-ri-dev/inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/ast";
		
		String copyFromBranchSubPath = "inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/ast";
		
		String blobPath = "inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/ast/BinaryTree.java";
		
		BranchData copyFromBranch = branchDetector.parseBranch(0L, copyFromPath);
		
		String alteredPath = GitBranchUtils.convertToTargetPath(path, 100L, copyFromPath, blobPath, copyFromBranch);
		
		Assert.assertEquals("poc/brms/brms-ri/branches/brms-ri-dev/inspect-rule-failure/src/main/java/io.github.svndump_to_git/rules/runtime/ast/BinaryTree.java", alteredPath);
	}
